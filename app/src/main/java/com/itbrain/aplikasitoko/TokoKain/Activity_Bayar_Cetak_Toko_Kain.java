...
public class Activity_Bayar_Cetak_Toko_Kain extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bayar_cetak_kain);
...
//            Toast.makeText(this, "Berhasil", Toast.LENGTH_SHORT).show();
    ...
    void sendData(String hasil) throws IOException {
        try {
            ...
            resetConnection();
            Toast.makeText(this, "Print Berhasil cetak", Toast.LENGTH_SHORT).show();
        } catch (NullPointerException e) {
            e.printStackTrace();
        } catch (Exception e) {
            e.printStackTrace();
                                ...
                                for (int i = 0; i < bytesAvailable; i++) {
                                    ...
                                    if (b == delimiter) {
                                        ...
                                        handler.post(new Runnable() {
                                            public void run() {
                                                Toast.makeText(Activity_Bayar_Cetak_Toko_Kain.this, data, Toast.LENGTH_SHORT).show();
                                            }
                                        });
                                    } else {
    ...
    public void keluar(){
        ...
        builder.setPositiveButton("Ya", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                Intent i = new Intent(Activity_Bayar_Cetak_Toko_Kain.this, Aplikasi_TokoKain_Menu_Utama_Toko_Kain.class);
    ...
    public void cari(View view) {
        Intent i = new Intent(this, Activity_Cari_Printer_Toko_Kain.class);
    ...
    public void cetak(View view) throws IOException {
        if(KumFunTokoKain.getText(v,R.id.viewNamaPrinter).equals("Tidak Ada Perangkat")){
            ...
            Intent i = new Intent(this, Aplikasi_TokoKain_Menu_Utama_Toko_Kain.class) ;
            i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP) ;
            startActivity(i);
        } else {
