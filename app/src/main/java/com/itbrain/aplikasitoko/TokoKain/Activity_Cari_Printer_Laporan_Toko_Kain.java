...
public class Activity_Cari_Printer_Laporan_Toko_Kain extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cari_printer_laporan_kain);
        ImageButton imageButton = findViewById(R.id.kembali6);
            ...
            list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    if (type.equals("pesan")) {
                        Intent in = new Intent(Activity_Cari_Printer_Laporan_Toko_Kain.this, Activity_Bayar_Cetak_Laporan_Toko_Kain.class);
                                ...
                                for (int i = 0; i < bytesAvailable; i++) {
                                    ...
                                    if (b == delimiter) {
                                        ...
                                        handler.post(new Runnable() {
                                            public void run() {
                                                Toast.makeText(Activity_Cari_Printer_Laporan_Toko_Kain.this, data, Toast.LENGTH_SHORT).show();
                                            }
                                        });
                                    } else {
