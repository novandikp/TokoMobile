...
public class Edit_Toko_Kain extends AppCompatActivity {
    Spinner spKat;
    Button btnSimpan;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.form_edit_kain);
    ...
    public void tambahkain(View view) {
        ...
        if (TextUtils.isEmpty(Nama) || TextUtils.isEmpty(Biaya) ){
            Toast.makeText(Edit_Toko_Kain.this, "Isi data terlebih dahulu!", Toast.LENGTH_SHORT).show();
        }else {
            if (idKat==(null)){
                Toast.makeText(Edit_Toko_Kain.this, "Pilih kategori terlebih dahulu!", Toast.LENGTH_SHORT).show();
            }else {
                if (idKain==null){
                    if (db.insertToKain(idKat,Nama,Biaya)){
                        Toast.makeText(Edit_Toko_Kain.this, "Tambah data berhasil", Toast.LENGTH_SHORT).show();
                        finish();
                    }else{
                        Toast.makeText(Edit_Toko_Kain.this, "Gagal", Toast.LENGTH_SHORT).show();
                    }
                }else {
