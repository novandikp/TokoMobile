...
public class ConfigKwitansi {
    static String type = "sqlite";
    static String host = "";
    static String user = "";
    static String pass = "";
    static String db   = "Store" ;
    static String dirBackup = "Store" ;
    static int version = 1 ;
    SharedPreferences sharedPreferences ;
    SharedPreferences.Editor editor ;

    ConfigKwitansi(SharedPreferences sharedPreferences){
    ...
    public static double toDouble (String it){
        double hasil = 0;
        try{
            hasil = Double.parseDouble(it);
        }catch (Exception e){
