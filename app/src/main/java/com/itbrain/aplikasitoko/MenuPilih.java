...
public class MenuPilih extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.menu_pilih);
...
//            getSupportActionBar().setTitle("Pilih Teknisi");
    ...
    public void getJasa(String cari) {
        ...
        while(c.moveToNext()){
            String campur = ModulBengkel.getString(c,"idbarang")+"__"+ModulBengkel.getString(c,"barang") + "__" + ModulBengkel.getString(c,"stok")+ "__" + ModulBengkel.getString(c,"harga")+"__"+ModulBengkel.getString(c,"idkategori")+ "__" + ModulBengkel.getString(c,"hargabeli");
            arrayList.add(campur);
        }
...
class MasterPilihBarang extends RecyclerView.Adapter<MasterPilihBarang.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        private TextView barang,deskripsi, tvOpt,tvHarga,harga;
        ...
        public ViewHolder(View view) {
            ...
            harga=view.findViewById(R.id.tvHarga1);
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, int i) {
        ...
        viewHolder.tvHarga.setText("Harga Jual: "+ModulBengkel.removeE(row[3]));
        viewHolder.harga.setText("Harga Beli: "+ModulBengkel.removeE(row[4]));
...
class MasterPilihJasa extends RecyclerView.Adapter<MasterPilihJasa.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        private TextView barang,deskripsi, tvOpt,tvHarga,hargabeli;
        private CardView cvBarang;
        ...
        public ViewHolder(View view) {
            ...
            cvBarang = view.findViewById(R.id.cvBarang);
            tvHarga=view.findViewById(R.id.tvHarga);
            hargabeli=view.findViewById(R.id.tvHarga1);
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, int i) {
        ...
        if (row[4].equals("1")){
            ...
            viewHolder.hargabeli.setVisibility(View.GONE);

        }else{
            viewHolder.deskripsi.setText("Stok :"+row[2]);
            viewHolder.hargabeli.setText("Harga Beli : " + ModulBengkel.removeE(row[5]));
        }
