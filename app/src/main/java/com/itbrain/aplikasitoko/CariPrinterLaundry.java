...
public class CariPrinterLaundry extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cari_printer_laundry);

        Modul.btnBack("Cari Perangkat", getSupportActionBar());
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (type.equals("pesan")) {
                    Intent in = new Intent(CariPrinterLaundry.this, MenuCetaklaundry.class);
                                ...
                                for (int i = 0; i < bytesAvailable; i++) {
                                    ...
                                    if (b == delimiter) {
                                        ...
                                        handler.post(new Runnable() {
                                            public void run() {
                                                Toast.makeText(CariPrinterLaundry.this, data, Toast.LENGTH_SHORT).show();
                                            }
                                        });
                                    } else {
