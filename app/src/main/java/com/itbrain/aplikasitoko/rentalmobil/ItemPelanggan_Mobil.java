...
public class ItemPelanggan_Mobil extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.itempelanggan_mobil);
    ...
    public void getPelanggan(String cari){
        ...
        RecyclerView.Adapter adapter = new AdapterPelangganMobil(this,arrayList) ;
    ...
    public void tambah(View view){
        Intent intent = new Intent(this, MenuPelanggan_Mobil.class);
...
class AdapterPelangganMobil extends RecyclerView.Adapter<AdapterPelangganMobil.ViewHolder>{
    ...
    public AdapterPelangganMobil(Context a, ArrayList<String> kota) {
        this.data = kota;
        c = a;
    }
                                ...
                                alertDialog.setMessage("Apakah anda yakin untuk menghapus data ini")
                                        ...
                                        .setPositiveButton("Iya", new DialogInterface.OnClickListener() {
                                            ...
                                            public void onClick(DialogInterface dialogInterface, int i) {
                                                ...
                                                if (db.exc(q)){
                                                    ((ItemPelanggan_Mobil)c).getPelanggan("");
                                                }else{
