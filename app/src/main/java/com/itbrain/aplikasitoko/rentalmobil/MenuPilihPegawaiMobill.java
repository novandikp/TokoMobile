...
public class MenuPilihPegawaiMobill extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.activity_menu_pilih_pegawai_mobil);
    ...
    class AdapterPilihPegawaiMobil extends RecyclerView.Adapter<AdapterPilihPegawaiMobil.ViewHolder>{
        ...
        public AdapterPilihPegawaiMobil(Context a, ArrayList<String> kota) {
            this.data = kota;
            c = a;
        }
        ...
        public void onBindViewHolder(@NonNull final ViewHolder holder, int i) {
            ...
            holder.cv.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ((MenuPilihPegawaiMobill)c).setResult(300,i);
                    ((MenuPilihPegawaiMobill)c).finish();
