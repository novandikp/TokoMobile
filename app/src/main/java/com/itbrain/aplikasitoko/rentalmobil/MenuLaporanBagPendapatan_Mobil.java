...
public class MenuLaporanBagPendapatan_Mobil extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.menulaporanbagpendapatan_mobil);
    ...
    public void getPesanan(String cari){
        ...
        RecyclerView.Adapter adapter = new AdapterPendapatanMobil(this,arrayList) ;
        recyclerView.setAdapter(adapter);
        String q= ModulRentalMobil.selectwhere("view_rental")+ModulRentalMobil.sWhere("flagrental","3")+" AND "+ModulRentalMobil.sLike("pelanggan",cari)+" AND "+ModulRentalMobil.sBetween("tglrental",tglAwal.getText().toString(),tglAkhir.getText().toString());
        Cursor c = db.sq(q) ;
        while(c.moveToNext()){
        ...
        ModulRentalMobil.setText(v,R.id.eTotal,ModulRentalMobil.removeE(total));
...
class AdapterPendapatanMobil extends RecyclerView.Adapter<AdapterPendapatanMobil.ViewHolder>{
    ...
    public AdapterPendapatanMobil(Context a, ArrayList<String> kota) {
        this.data = kota;
        c = a;
    }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_view_pendapatan_mobil, parent, false);
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int i) {
        ...
        holder.cv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(c, MenuCetak2_Mobil.class);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            cv=itemView.findViewById(R.id.tvOpt);
