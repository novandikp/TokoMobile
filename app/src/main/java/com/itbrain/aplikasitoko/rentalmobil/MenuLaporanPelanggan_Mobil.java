...
public class MenuLaporanPelanggan_Mobil extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu_laporan_satu_mobil);
    ...
    public void getPelanggan(String cari){
        ...
        RecyclerView.Adapter adapter = new AdapterLaporanPelangganMobil(this,arrayList) ;
...
class AdapterLaporanPelangganMobil extends RecyclerView.Adapter<AdapterLaporanPelangganMobil.ViewHolder>{
    ...
    public AdapterLaporanPelangganMobil(Context a, ArrayList<String> kota) {
        this.data = kota;
        c = a;
    }
