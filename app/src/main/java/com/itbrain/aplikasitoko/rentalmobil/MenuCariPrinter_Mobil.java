...
public class MenuCariPrinter_Mobil extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu_cari_printer_mobil);

        final ModulRentalMobil temp = new ModulRentalMobil(getSharedPreferences("config",this.MODE_PRIVATE));
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent in;
                if (type.equals("dp")){
                    in= new Intent(MenuCariPrinter_Mobil.this, MenuCetak_Mobil.class) ;
                }else{
                    in= new Intent(MenuCariPrinter_Mobil.this, MenuCetak2_Mobil.class) ;
                }
                                ...
                                for (int i = 0; i < bytesAvailable; i++) {
                                    ...
                                    if (b == delimiter) {
                                        ...
                                        handler.post(new Runnable() {
                                            public void run() {
                                                Toast.makeText(MenuCariPrinter_Mobil.this, data, Toast.LENGTH_SHORT).show();
                                            }
                                        });
                                    } else {
