...
import com.itbrain.aplikasitoko.MenuCetak;
...
public class MenuCariPrinterBengkel extends AppCompatActivity {
...
//        getSupportActionBar().setDisplayShowHomeEnabled(true);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent in = new Intent(MenuCariPrinterBengkel.this, MenuCetak.class) ;
                                ...
                                for (int i = 0; i < bytesAvailable; i++) {
                                    ...
                                    if (b == delimiter) {
                                        ...
                                        handler.post(new Runnable() {
                                            public void run() {
                                                Toast.makeText(MenuCariPrinterBengkel.this, data, Toast.LENGTH_SHORT).show();
                                            }
                                        });
                                    } else {
