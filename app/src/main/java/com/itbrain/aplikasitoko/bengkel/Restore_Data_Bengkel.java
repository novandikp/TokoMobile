...
public class Restore_Data_Bengkel extends AppCompatActivity {
    ListView listView ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.restore_data_bengkel);
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        if(ModulBengkel.deleteFile(dirIn+Database_Bengkel_.nama)){
                            if(ModulBengkel.copyFile(dirOut,dirIn,db)){
                                ...
                                a.renameTo(b) ;
                                ModulBengkel.showToast(Restore_Data_Bengkel.this,"Reset Berhasil, Aplikasi terestart");
                                finishAffinity();

                                System.exit(0);

                            } else {
                                ModulBengkel.showToast(Restore_Data_Bengkel.this,"Restore Gagal");
                            }
                        } else {
                            ModulBengkel.showToast(Restore_Data_Bengkel.this,"Restore Gagal");
                        }
