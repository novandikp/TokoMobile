...
public class Laporan_Penjualan_per_Barang_Kasir extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.laporan_penjualan_per_barang_kasir);
        ...
        final EditText eCari = (EditText) findViewById(R.id.eCariLaporanPerBarang);
        ...
        Spinner spinner = (Spinner) findViewById(R.id.spinnerPerBarang);
    ...
    public void exportLaporanPerBarang(View view){
...
//        });
    ...
    public void setText(){
        ...
        FFunctionKasir.setText(v,R.id.eKePerBar,now) ;
        FFunctionKasir.setText(v,R.id.eDariPerBar,now) ;
    }

    public void loadList3(String cari){
        String item = FFunctionKasir.getSpinnerItem(v,R.id.spinnerPerBarang) ;
        String bayar = "" ;
        String q = "" ;
        ...
        if(FFunctionKasir.getCount(c) > 0){
            double jum = 0 ;
            FFunctionKasir.setText(v,R.id.asw,"Jumlah Data : "+FFunctionKasir.intToStr(FFunctionKasir.getCount(c))) ;
            while(c.moveToNext()){
                String pelanggan = FFunctionKasir.getString(c,"pelanggan") ;
                String kembali = FFunctionKasir.getString(c,"barang") ;
                String faktur = FFunctionKasir.getString(c,"fakturbayar") ;
            ...
            String a = FFunctionKasir.removeE(jum) ;
            FFunctionKasir.setText(v,R.id.afs,"Rp. "+a) ;
        } else {
            FFunctionKasir.setText(v,R.id.afs,"Rp. 0") ;
            FFunctionKasir.setText(v,R.id.asw,"Jumlah Data : 0") ;
        }
        adapter.notifyDataSetChanged();
    }
    ...
    public void submit(){
        try{
                loadList3(FFunctionKasir.getText(v,R.id.eCariLaporanPerBarang));
...
//    }
    ...
    private DatePickerDialog.OnDateSetListener edit1 = new DatePickerDialog.OnDateSetListener() {
        ...
        public void onDateSet(DatePicker arg0, int thn, int bln, int day) {
            FFunctionKasir.setText(v, R.id.eDariPerBar, FFunctionKasir.setDatePickerNormal(thn,bln+1,day)) ;
    ...
    private DatePickerDialog.OnDateSetListener edit2 = new DatePickerDialog.OnDateSetListener() {
        @Override
        public void onDateSet(DatePicker arg0, int thn, int bln, int day) {
            FFunctionKasir.setText(v, R.id.eKePerBar, FFunctionKasir.setDatePickerNormal(thn,bln+1,day)) ;
