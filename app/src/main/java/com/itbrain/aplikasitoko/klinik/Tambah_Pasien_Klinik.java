...
public class Tambah_Pasien_Klinik extends AppCompatActivity {
    String type;
    DatabaseKlinik db;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tambah_pasien_klinik);
    ...
    public void getPasien(String cari) {
        ...
        RecyclerView.Adapter adapter = new AdapterPasien(this,arrayList) ;
    ...
    public void tambah (View view) {
        if (MainActivity.status){
            startActivity(new Intent(Tambah_Pasien_Klinik.this,MenuTambahPasienKlinik.class));
        }else {
            startActivity(new Intent(this,MenuTambahPasienKlinik.class));
        }
...
class AdapterPasien extends RecyclerView.Adapter<AdapterPasien.ViewHolder> {
    ...
    public AdapterPasien(Context a, ArrayList<String> kota) {
        this.data = kota;
        c = a;
    }
                ...
                popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        switch (item.getItemId()) {
                            case R.id.menu_edit:
                                Intent intent = new Intent(c,MenuUbahPasienKlinik.class);
                                ...
                                alertDialog.setMessage("Apakah anda yakin untuk menghapus data ini")
                                        ...
                                        .setPositiveButton("Iya", new DialogInterface.OnClickListener() {
                                            ...
                                            public void onClick(DialogInterface dialogInterface, int i) {
                                                ...
                                                String q = "DELETE FROM tblpasien WHERE idpasien=" + id;
                                                if (db.exc(q)) {
                                                    ((Tambah_Pasien_Klinik) c).getPasien("");
                                                } else {
