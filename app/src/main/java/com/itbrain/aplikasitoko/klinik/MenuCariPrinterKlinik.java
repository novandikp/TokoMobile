...
public class MenuCariPrinterKlinik extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu_cari_printer_klinik);


        final ModulKlinik temp = new ModulKlinik(getSharedPreferences("config", this.MODE_PRIVATE));
        list = (ListView) findViewById(R.id.listViewCetak);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent in = new Intent(MenuCariPrinterKlinik.this, MenuCetakKLinik.class);
                                ...
                                for (int i = 0; i < bytesAvailable; i++) {
                                    ...
                                    if (b == delimiter) {
                                        ...
                                        handler.post(new Runnable() {
                                            public void run() {
                                                Toast.makeText(MenuCariPrinterKlinik.this, data, Toast.LENGTH_SHORT).show();
                                            }
                                        });
                                    } else {
