...
public class PrefLaundry {
    static String type = "sqlite";
    static String host = "";
    static String user = "";
    static String pass = "";
    static String db   = "db_laundry_keuangan" ;
    static String dirBackup = "Laundry Plus Keuangan" ;
    ...
    static String productID="versipro_laundrypluskeuangan";
    static String produkid2 ="com.komputerkit.laundrypluskeuangan.full";
//   static String productID="android.test.purchased";
    ...
    PrefLaundry(SharedPreferences sharedPreferences){
