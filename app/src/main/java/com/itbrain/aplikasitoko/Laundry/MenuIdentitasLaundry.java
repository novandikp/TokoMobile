...
public class MenuIdentitasLaundry extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton i = findViewById(R.id.kembali9);
        ...
        if(ModulLaundry.getCount(c)==1){
            setText() ;
        }

        btnClear = (Button) findViewById(R.id.button4);
        edt1 = (TextInputEditText)findViewById(R.id.Namatoko);
        edt2 = (TextInputEditText)findViewById(R.id.Alamattoko);
        edt3 = (TextInputEditText)findViewById(R.id.Nomertoko);
        ...
        btnClear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                edt1.getText().clear();edt2.getText().clear();edt3.getText().clear();edt4.getText().clear();edt5.getText().clear();edt5.getText().clear();
            }
        });
    }
    ...
    public void setText(){
        ...
        c.moveToNext() ;
        ModulLaundry.setText(v,R.id.Namatoko, ModulLaundry.getString(c,"namatoko")) ;
        ModulLaundry.setText(v,R.id.Alamattoko, ModulLaundry.getString(c,"alamattoko")) ;
        ModulLaundry.setText(v,R.id.Nomertoko, ModulLaundry.getString(c,"notelptoko")) ;
        ModulLaundry.setText(v,R.id.cap1, ModulLaundry.getString(c,"caption_1")) ;
        ModulLaundry.setText(v,R.id.cap2, ModulLaundry.getString(c,"caption_2")) ;
        ModulLaundry.setText(v,R.id.cap3, ModulLaundry.getString(c,"caption_3")) ;
    }

    public void simpan(View view) {
        if(ModulLaundry.getText(v,R.id.Namatoko).isEmpty()||
                ModulLaundry.getText(v,R.id.Alamattoko).isEmpty()||
                ModulLaundry.getText(v,R.id.Nomertoko).isEmpty()||
                ModulLaundry.getText(v,R.id.cap1).isEmpty()||
                ModulLaundry.getText(v,R.id.cap2).isEmpty()||
                ModulLaundry.getText(v,R.id.cap3).isEmpty()){
            Toast.makeText(this, "Isi semua form terlebih dahulu", Toast.LENGTH_SHORT).show();
        }else {
            Cursor c = db.sq(Query.select("tblidentitas"));
            String[] p = {"1", ModulLaundry.getText(v, R.id.Namatoko),
                    ModulLaundry.getText(v, R.id.Alamattoko),
                    ModulLaundry.getText(v, R.id.Nomertoko),
                    ModulLaundry.getText(v, R.id.cap1),
                    ModulLaundry.getText(v, R.id.cap2),
                    ModulLaundry.getText(v, R.id.cap3)
            };
            String[] p1 = {ModulLaundry.getText(v, R.id.Namatoko),
                    ModulLaundry.getText(v, R.id.Alamattoko),
                    ModulLaundry.getText(v, R.id.Nomertoko),
                    ModulLaundry.getText(v, R.id.cap1),
                    ModulLaundry.getText(v, R.id.cap2),
            ...
            String q = "";
            if (ModulLaundry.getCount(c) == 1) {
                q = Query.splitParam("UPDATE tblidentitas SET namatoko=? , alamattoko=? ,notelptoko=? ,caption_1=? , caption_2=? , caption_3=? WHERE ididentitas=?   ", p1);
            } else {
