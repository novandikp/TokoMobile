...
public class Export_Exel_Laundry_2 extends AppCompatActivity {
        String tab;
        View v;
        DatabaseLaundry db;
        String path;
    ...
    String ttglAwal,ttglAkhir;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.export_exel_laundry_2);
        ...
        public void export(View view) throws IOException, WriteException  {
            if (tab.equals("laundry")){
                ...
                exLaundry();
            }else if(tab.equals("proseslaundry")){
                nama="Laporan Proses Laundry";
                exProsesLaundry();
            }else if(tab.equals("pendapatan")){
                nama="Laporan Pendapatan";
                exPendapatan();

            } else if (tab.equals("keuangan")){
    ...
    //        cv.setAutosize(true);
        ...
        private DatePickerDialog.OnDateSetListener date = new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker arg0, int thn, int bln, int day) {
                ttglAwal = ModulLaundry.convertDate(ModulLaundry.setDatePickerNormal(thn,bln+1,day));


                ModulLaundry.setText(v, R.id.tglAwal, ModulLaundry.setDatePickerNormal(thn, bln + 1, day));
            }
        };
        ...
        private DatePickerDialog.OnDateSetListener date1 = new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker arg0, int thn, int bln, int day) {
                ...
                ttglAkhir = ModulLaundry.convertDate(ModulLaundry.setDatePickerNormal(thn,bln+1,day));

                ModulLaundry.setText(v, R.id.tglAkhir, ModulLaundry.setDatePickerNormal(thn, bln + 1, day));
            }
        };
        ...
        void setTanggal(){
            ...
            String now = ModulLaundry.setDatePickerNormal(year,month+1,day) ;
            ModulLaundry.setText(v,R.id.tglAwal,now) ;
            ModulLaundry.setText(v,R.id.tglAkhir,now) ;
            ttglAwal = ModulLaundry.convertDate(ModulLaundry.setDatePickerNormal(year,month+1,day));
            ttglAkhir = ModulLaundry.convertDate(ModulLaundry.setDatePickerNormal(year,month+1,day));
