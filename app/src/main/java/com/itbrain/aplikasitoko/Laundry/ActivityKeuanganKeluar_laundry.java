...
public class ActivityKeuanganKeluar_laundry extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.keuangan_keluar_laundry);
        ...
        TextInputLayout tilBayar=(TextInputLayout) findViewById(R.id.textInputLayout28);
            tempFaktur="UANG-KELUAR-";
            tilBayar.setHint("Pengeluaran");
    ...
    public void tambah(View view) {
        ...
        if (!dataBenar){
            Toast.makeText(ActivityKeuanganKeluar_laundry.this, "Masukkan data dengan benar", Toast.LENGTH_SHORT).show();
        }else {
            AlertDialog dialog =new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton("Ya", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            if (db.exc(q[0])){
                                Toast.makeText(ActivityKeuanganKeluar_laundry.this, "Berhasil", Toast.LENGTH_SHORT).show();
                                finish();
                            }
                        }
                    })
