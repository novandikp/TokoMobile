...
public class NumberTextWatcherKembali implements TextWatcher {
    ...
    public NumberTextWatcherKembali(EditText et, Locale locale, int numDecimals,String total,EditText edtkembali) {
    ...
    public void afterTextChanged(Editable s) {
        ...
        try {
            ...
            double kembali= ModulLaundry.strToDouble(ModulLaundry.parseDF(s.toString()))- ModulLaundry.strToDouble(total);
            edtKembali.setText(ModulLaundry.removeE(ModulLaundry.doubleToStr(kembali)));
