...
public class Form_Pembayaran_Booking_Salon_ extends AppCompatActivity {
    ...
    View v;
    Calendar calendar;
    String faktur="00000000", tnPelanggan, tnJasa="", tnHarga="", tnTglJanji;
    int year, month, day, tJumlah=0, tIdpelanggan, tIdJasa, tIdJanji, isikeranjang=0;
    ImageButton btnCariJanji, btnCariJasa, btnAddJ, btnRemoveJ;
    ...
    private void getFaktur(){
        List<Integer> idorderr = new ArrayList<Integer>();
        String q = "SELECT idorder FROM tblorder";
        Cursor c = db.sq(q);
        if (c.moveToNext()){
            do {
                idorderr.add(c.getInt(0));
            } while (c.moveToNext());
        }
        String tempFaktur="";
        int idFaktur=0;
        if (FunctionSalon.getCount(c)==0){
            ...
            idFaktur = idorderr.get(FunctionSalon.getCount(c)-1)+1;
    ...
    private void btnCari(){
        ...
        btnCariJasa.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i= new Intent(Form_Pembayaran_Booking_Salon_.this, ActivityPembayaranCariSalon.class);
                i.putExtra("cari","jasa");
                startActivityForResult(i,2000);
            }
        });

        btnCariJanji=(ImageButton)findViewById(R.id.ibtnNamaPelanggan);
        btnCariJanji.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i= new Intent(Form_Pembayaran_Booking_Salon_.this, ActivityPembayaranCariSalon.class);
                i.putExtra("cari","janji");
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (resultCode==2000){
            ...
            tIdJanji=data.getIntExtra("idjanji",0);
            tIdpelanggan=data.getIntExtra("idpelanggan",0);
            tnPelanggan=data.getStringExtra("pelanggan");
            tnTglJanji=data.getStringExtra("tgljanji");
            getJanji(FunctionSalon.intToStr(tIdJanji));
        }
    }
    ...
    public void getJanji(String idjanji){
        String q = QuerySalon.selectwhere("qjanji") + QuerySalon.sWhere("idjanji", idjanji) ;
        Cursor c = db.sq(q) ;
        c.moveToNext() ;
        FunctionSalon.setText(v,R.id.edtNamaPelanggan,FunctionSalon.getString(c, "pelanggan")) ;
        FunctionSalon.setText(v,R.id.edtTglBooking,FunctionSalon.dateToNormal(FunctionSalon.getString(c,"tgljanji"))) ;
    }
    ...
    private void keluar(){
        ...
        builder.setPositiveButton("Ya", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                db.exc(q);
                Intent i = new Intent(Form_Pembayaran_Booking_Salon_.this, Aplikasi_Salon_Menu_Transaksi.class) ;
    ...
    public void insertTransaksi(View view) {
        ...
        String eTglB = FunctionSalon.getText(v,R.id.edtTglBooking);
        ...
        if (TextUtils.isEmpty(eTglB) || TextUtils.isEmpty(eNJasa) || TextUtils.isEmpty(eNPelanggan) || FunctionSalon.strToDouble(eHarga)==0 || FunctionSalon.strToDouble(eJumlah)==0) {
...
//                loadCart();
    ...
    public void loadCart(){
        ...
        RecyclerView.Adapter adapter=new AdapterPembayaranBooking(this,arrayList);
...
class AdapterPembayaranBooking extends RecyclerView.Adapter<AdapterPembayaranBooking.PembayaranViewHolder> {
    private Context ctxAdapter;
    private ArrayList<String> data;

    public AdapterPembayaranBooking(Context ctxAdapter, ArrayList<String> data) {
                        ...
                        .setPositiveButton("Ya", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                if (db.exc(q)) {
                                    ...
                                    ((Form_Pembayaran_Booking_Salon_) ctxAdapter).getTotal();
                                    ((Form_Pembayaran_Booking_Salon_) ctxAdapter).loadCart();
                                } else {
