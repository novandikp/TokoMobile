...
public class Edit_Pelanggan_Salon extends AppCompatActivity {
        ...
        btnSimpan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (namapelanggan.equals("") || alamat.equals("") || notelp.equals("")) {
                    Toast.makeText(Edit_Pelanggan_Salon.this, "Masukan Data Dengan Benar", Toast.LENGTH_SHORT).show();
                } else {
                    DatabaseSalon db = new DatabaseSalon(Edit_Pelanggan_Salon.this);
                    if (idPelanggan == null) {
                        if (db.insertPelanggan(namapelanggan, alamat, notelp)) {
                            Toast.makeText(Edit_Pelanggan_Salon.this, "Tambah Pelanggan berhasil", Toast.LENGTH_SHORT).show();
                            finish();
                        } else {
                            Toast.makeText(Edit_Pelanggan_Salon.this, "Tambah data gagal", Toast.LENGTH_SHORT).show();
                        }
                    } else {
                        if (db.updatePelanggan(idPelanggan, namapelanggan, alamat, notelp)) {
                            Toast.makeText(Edit_Pelanggan_Salon.this, "Berhasil memperbarui data", Toast.LENGTH_SHORT).show();
                            finish();
                        } else {
                            Toast.makeText(Edit_Pelanggan_Salon.this, "Gagal memperbaharui data", Toast.LENGTH_SHORT).show();
                        }
                    }
                }
            }
