...
public class FConfigKredit {
    ...
    static String user = "";
    static String pass = "";
    static String db = "postokokredit_plus_keuangan.db";
    static String dirBackup = "postokokredit";
    static int version = 1;
    SharedPreferences sharedPreferences;
    SharedPreferences.Editor editor;

    public FConfigKredit(SharedPreferences sharedPreferences) {
