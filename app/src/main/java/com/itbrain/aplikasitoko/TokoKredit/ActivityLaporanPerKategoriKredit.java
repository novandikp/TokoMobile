...
public class ActivityLaporanPerKategoriKredit extends AppCompatActivity {
    ...
    AdapterLaporanPerKategori AdapterLaporanPerKategori;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_laporan_per_kategori_kredit);
    ...
    void init() {
        ...
        AdapterLaporanPerKategori = new AdapterLaporanPerKategori(this, daftarLaporanPenjualan);
        RecyclerView recUtang = findViewById(R.id.recUtang);
        recUtang.setAdapter(AdapterLaporanPerKategori);
    ...
    public void itemnyelect(String selected) {
        ...
        RecyclerView.Adapter adapter = new AdapterLaporanPerKategori(this, daftarLaporanPenjualan);
...
//        });
    ...
    public void loadList(String cari) {
        ...
        AdapterLaporanPerKategori.notifyDataSetChanged();
    }
...
class AdapterLaporanPerKategori extends RecyclerView.Adapter<AdapterLaporanPerKategori.ViewHolder> {
    private List<String> data;
    Context c;

    AdapterLaporanPerKategori(Context a, List<String> kota) {
        this.data = kota;
        c = a;
    }
