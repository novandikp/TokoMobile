...
public class ActivityLaporanPendapatanKredit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_laporan_pendapatan_kredit);
    ...
    public void open(final String faktur) {
        ...
        alertDialogBuilder.setPositiveButton("Iya", (arg0, arg1) -> {
            ...
            if (!faktur.equals("tidak")) {
                ...
                Toast.makeText(ActivityLaporanPendapatanKredit.this, "Hapus Berhasil", Toast.LENGTH_SHORT).show();
                getPendapatan("");
            }
        });
...
class AdapterPendapatan extends RecyclerView.Adapter<AdapterPendapatan.ViewHolder> {
    ...
    AdapterPendapatan(Context a, ArrayList<String> kota) {
        this.data = kota;
        c = a;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.activity_laporan_transaksi_pendapatan_kredit, viewGroup, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            bCetak = view.findViewById(R.id.bCetak);
        }
    }
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        viewHolder.bCetak.setOnClickListener(v -> {
            Intent intent = new Intent(c, ActivityCetakSatuKredit.class);
            intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            intent.putExtra("fakturbayar", row[4]);
            intent.putExtra("owner", ActivityLaporanPendapatanKredit.class);
