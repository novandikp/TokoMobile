...
public class ActivityLaporanPenjualanKredit extends AppCompatActivity {
    ...
    AdapterLaporanPenjualan adapterLaporanPenjualan;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_laporan_penjualan_kredit);
    ...
    void init() {
        ...
        adapterLaporanPenjualan = new AdapterLaporanPenjualan(this, daftarLaporanPenjualan);
        RecyclerView recUtang = findViewById(R.id.recUtang);
        recUtang.setAdapter(adapterLaporanPenjualan);
    ...
    public void itemnyelect(String selected) {
        ...
        RecyclerView.Adapter adapter = new AdapterLaporanPenjualan(this, daftarLaporanPenjualan);
    ...
    public void loadList(String cari) {
        ...
        adapterLaporanPenjualan.notifyDataSetChanged();
    }
...
class AdapterLaporanPenjualan extends RecyclerView.Adapter<AdapterLaporanPenjualan.ViewHolder> {
    ...
    AdapterLaporanPenjualan(Context a, List<String> kota) {
        this.data = kota;
        c = a;
    }
