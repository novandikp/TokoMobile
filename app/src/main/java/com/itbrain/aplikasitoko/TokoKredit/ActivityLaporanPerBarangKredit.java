...
public class ActivityLaporanPerBarangKredit extends AppCompatActivity {
    ...
    AdapterLaporanPerBarang AdapterLaporanPerBarang;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_laporan_per_barang_kredit);
    ...
    void init() {
        ...
        AdapterLaporanPerBarang = new AdapterLaporanPerBarang(this, daftarLaporanPenjualan);
        RecyclerView recUtang = findViewById(R.id.recUtang);
        recUtang.setAdapter(AdapterLaporanPerBarang);
    ...
    public void itemnyelect(String selected) {
        ...
        RecyclerView.Adapter adapter = new AdapterLaporanPerBarang(this, daftarLaporanPenjualan);
...
//        });
    ...
    public void loadList(String cari) {
        ...
        AdapterLaporanPerBarang.notifyDataSetChanged();
    }
...
class AdapterLaporanPerBarang extends RecyclerView.Adapter<AdapterLaporanPerBarang.ViewHolder> {
    private List<String> data;
    Context c;

    AdapterLaporanPerBarang(Context a, List<String> kota) {
        this.data = kota;
        c = a;
    }
