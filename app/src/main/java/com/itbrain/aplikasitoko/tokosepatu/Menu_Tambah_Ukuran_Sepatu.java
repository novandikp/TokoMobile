...
public class Menu_Tambah_Ukuran_Sepatu extends AppCompatActivity {
    String id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Tambah detail barang");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);

        id=getIntent().getStringExtra("idbar");
        ...
        harga.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if (!hasFocus){
                    ...
                    keyboard();
                    hidekeyboarddef(Menu_Tambah_Ukuran_Sepatu.this);
                }
            }
        });
    ...
    private void tambahUkuran(){
        ...
        if (ModulTokoSepatu.strToDouble(ModulTokoSepatu.unNumberFormat(harga))<1 || ModulTokoSepatu.strToDouble(stok)<1){
            ...
            String[] p = {ModulTokoSepatu.toUppercase(ukuran),barang,ModulTokoSepatu.unNumberFormat(harga),stok} ;
            String q = ModulTokoSepatu.splitParam("INSERT INTO tblukuran (ukuran,idbarang,harga,stok) values(?,?,?,?)",p) ;
            if(db.exc(q)){
