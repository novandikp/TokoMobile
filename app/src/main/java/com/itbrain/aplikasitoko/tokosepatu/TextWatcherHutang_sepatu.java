...
public class TextWatcherHutang_sepatu implements TextWatcher {
    ...
    public TextWatcherHutang_sepatu(EditText et, String total, EditText baru, Locale locale, int numDecimals) {
...
//        et.setKeyListener(DigitsKeyListener.getInstance("0123456789.,"));
    ...
    public void onTextChanged(CharSequence s, int start, int before, int count) {
        ...
        double kembali= ModulTokoSepatu.strToDouble(ModulTokoSepatu.unNumberFormat(et.getText().toString()))-ModulTokoSepatu.strToDouble(total);
