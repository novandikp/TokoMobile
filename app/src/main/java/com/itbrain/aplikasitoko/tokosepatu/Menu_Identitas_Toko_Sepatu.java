...
public class Menu_Identitas_Toko_Sepatu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu_identitas_toko_sepatu);
        Toolbar toolbar = findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Identitas Toko");
    ...
    private void setPelanggan() {
        ...
        if (c.getCount() > 0) {
            c.moveToNext();
            ModulTokoSepatu.setText(v, R.id.eNamaToko, ModulTokoSepatu.getString(c, "namatoko"));
            ModulTokoSepatu.setText(v, R.id.eAlamatToko, ModulTokoSepatu.getString(c, "alamattoko"));
            ModulTokoSepatu.setText(v, R.id.eNoToko, ModulTokoSepatu.getString(c, "notoko"));
            ModulTokoSepatu.setText(v, R.id.eCaption1, ModulTokoSepatu.getString(c, "caption1"));
            ModulTokoSepatu.setText(v, R.id.eCaption2, ModulTokoSepatu.getString(c, "caption2"));
            ModulTokoSepatu.setText(v, R.id.eCaption3, ModulTokoSepatu.getString(c, "caption3"));
        }
    }


    private void tambahidentitas() {
        String nama = ModulTokoSepatu.getText(v, R.id.eNamaToko);
        String alamat = ModulTokoSepatu.getText(v, R.id.eAlamatToko);
        String notelp = ModulTokoSepatu.getText(v, R.id.eNoToko);
        String caption1 = ModulTokoSepatu.getText(v, R.id.eCaption1);
        String caption2 = ModulTokoSepatu.getText(v, R.id.eCaption2);
        String caption3 = ModulTokoSepatu.getText(v, R.id.eCaption3);
        ...
        if (!TextUtils.isEmpty(nama) && !TextUtils.isEmpty(alamat) && !TextUtils.isEmpty(notelp) && !TextUtils.isEmpty(caption1) && !TextUtils.isEmpty(caption2) && !TextUtils.isEmpty(caption3)) {
            ...
            String q = ModulTokoSepatu.splitParam("INSERT OR REPLACE INTO tbltoko (idtoko,namatoko,alamattoko,notoko,caption1,caption2,caption3) values(1,?,?,?,?,?,?)", p);
            if (db.exc(q)) {
                ModulTokoSepatu.showToast(Menu_Identitas_Toko_Sepatu.this, "Identitas telah tersimpan");
            } else {
    ...
    public void reset(View view) {
        ModulTokoSepatu.setText(v, R.id.eNamaToko, "");
        ModulTokoSepatu.setText(v, R.id.eAlamatToko, "");
        ModulTokoSepatu.setText(v, R.id.eNoToko, "");
        ModulTokoSepatu.setText(v, R.id.eCaption1, "");
        ModulTokoSepatu.setText(v, R.id.eCaption2, "");
        ModulTokoSepatu.setText(v, R.id.eCaption3, "");
    }
