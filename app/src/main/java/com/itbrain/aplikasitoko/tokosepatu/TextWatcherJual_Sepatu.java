...
public class TextWatcherJual_Sepatu implements TextWatcher {
    ...
    public TextWatcherJual_Sepatu(EditText et, EditText total, EditText baru, Locale locale, int numDecimals) {
...
//        et.setKeyListener(DigitsKeyListener.getInstance("0123456789.,"));
    ...
    public void onTextChanged(CharSequence s, int start, int before, int count) {
        ...
        double kembali= ModulTokoSepatu.strToDouble(ModulTokoSepatu.unNumberFormat(et.getText().toString()))-ModulTokoSepatu.strToDouble(ModulTokoSepatu.unNumberFormat(total.getText().toString()));
