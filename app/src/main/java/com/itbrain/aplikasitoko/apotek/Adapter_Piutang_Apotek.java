...
class Adapter_Piutang_Apotek extends RecyclerView.Adapter<Adapter_Piutang_Apotek.ViewHolder> {
    ...
    public Adapter_Piutang_Apotek(Context a, ArrayList<String> kota) {
        this.data = kota;
        c = a;
    }
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int i) {
        ...
        holder.cv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i =new Intent(c, Menu_Bayar_Piutang_Apotek.class);
