...
public class Laporan_Pembayaran_Hutang_Apotek_ extends AppCompatActivity {
    int year, day, month;
    Calendar calendar;
    ...
    public void getHutang(String cari) {
        arrayList.clear();
        RecyclerView recyclerView = (RecyclerView) findViewById(R.id.recPenghutang);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        recyclerView.setHasFixedSize(true);
        RecyclerView.Adapter adapter = new Adapter_Laporan_Hutang_Apotek(this, arrayList);
        recyclerView.setAdapter(adapter);
        String q = ModulApotek.selectwhere("qhutang1") + ModulApotek.sBetween("tglbayar", ModulApotek.getText(v, R.id.tgl1), ModulApotek.getText(v, R.id.tgl2)) + " AND " + ModulApotek.sLike("supplier", cari);
        Cursor c = db.sq(q);
        while (c.moveToNext()) {
            String campur = ModulApotek.getString(c, "idutang") + "__" + ModulApotek.getString(c, "supplier") + "__" + ModulApotek.getString(c, "tglbayar") + "__" + ModulApotek.getString(c, "bayarhutang");
