...
class Adapter_Pelanggan_Apotek extends RecyclerView.Adapter<Adapter_Pelanggan_Apotek.ViewHolder>{
    ...
    public Adapter_Pelanggan_Apotek(Context a, ArrayList<String> kota) {
        this.data = kota;
        c = a;
    }
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        switch (item.getItemId()){
                            case R.id.menu_edit:
                                ...
                                Intent i=new Intent(c,Form_Ubah_Pelanggan_Apotek_.class);
                                i.putExtra("id",id);
                                c.startActivity(i);
                                break;
