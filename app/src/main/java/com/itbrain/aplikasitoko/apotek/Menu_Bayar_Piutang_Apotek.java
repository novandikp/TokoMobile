...
public class Menu_Bayar_Piutang_Apotek extends AppCompatActivity {
    DatabaseApotek db;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.menu_bayar_piutang_apotek);
    ...
    protected void setText(){
            String q= ModulApotek.selectwhere("tblpelanggan")+ ModulApotek.sWhere("idpelanggan",idpelanggan);
            Cursor c= db.sq(q);
            c.moveToNext();
            ModulApotek.setText(v,R.id.ePelanggan, ModulApotek.getString(c,"pelanggan"));
            ModulApotek.setText(v,R.id.eTotal, ModulApotek.removeE(ModulApotek.getString(c,"hutang")));
    ...
    public void transaks(){
        ...
        Cursor b = db.sq(ModulApotek.select("tblhutang"));
        int id = b.getCount();
        String faktur="00000000";
        faktur =faktur.substring(0,faktur.length()- ModulApotek.intToStr(id).length())+ ModulApotek.intToStr(id);
        String [] isi={tgl,"Pelunasan Piutang "+ ModulApotek.getText(v,R.id.ePelanggan),faktur,hutang, ModulApotek.doubleToStr(saldo)};
    ...
    public void byr(){
        ...
        String qq = ModulApotek.splitParam("INSERT INTO tblhutang (bayarhutang,tglbayar,idpelanggan) VALUES (?,?,?) ",pp) ;
        db.exc(qq);
        transaks();
        tambahlimit();
