...
public class MenuMasterIdentitasTabungan extends AppCompatActivity {
    View v;
    DatabaseTabungan db;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu_master_identitas_tabungan);
        ModulTabungan.btnBack(R.string.title_master_identitas,getSupportActionBar());
        this.getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_STATE_ALWAYS_HIDDEN);
        v=this.findViewById(android.R.id.content);
        this.getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_STATE_ALWAYS_HIDDEN);
        db=new DatabaseTabungan(this);
        String cCode="+"+String.valueOf(ModulTabungan.getCurrentCountryCode(this));
        ModulTabungan.setText(v,R.id.tvCountryCode,cCode);
        ...
        ImageButton imageButton = findViewById(R.id.kembali_identitas_tabungan);
    ...
    public void setText(){
        ...
        c.moveToFirst();
        ModulTabungan.setText(v,R.id.edtNamaToko,ModulTabungan.getString(c,"namatoko")) ;
        ModulTabungan.setText(v,R.id.edtAlamatToko,ModulTabungan.getString(c,"alamat")) ;
        ModulTabungan.setText(v,R.id.edtTeleponToko,ModulTabungan.getString(c,"notelp")) ;
        ModulTabungan.setText(v,R.id.edtCaption1,ModulTabungan.getString(c,"caption1")) ;
        ModulTabungan.setText(v,R.id.edtCaption2,ModulTabungan.getString(c,"caption2")) ;
        ModulTabungan.setText(v,R.id.edtCaption3,ModulTabungan.getString(c,"caption3")) ;
    }

    public void simpanIdentitas(View view) {
        String nama=ModulTabungan.getText(v,R.id.edtNamaToko);
        String alamat=ModulTabungan.getText(v,R.id.edtAlamatToko);
        String notelp=ModulTabungan.getText(v,R.id.edtTeleponToko);
        String caption1=ModulTabungan.getText(v,R.id.edtCaption1);
        String caption2=ModulTabungan.getText(v,R.id.edtCaption2);
        String caption3=ModulTabungan.getText(v,R.id.edtCaption3);
        Cursor c = db.sq(QueryTabungan.select("tblidentitas"));
        String[] p = {"1",
                nama,
                notelp,
        ...
        if (nama.isEmpty()||alamat.isEmpty()||notelp.isEmpty()||caption1.isEmpty()||caption2.isEmpty()||caption3.isEmpty()){
            Toast.makeText(this, ModulTabungan.getResString(this,R.string.formnull), Toast.LENGTH_SHORT).show();
        }else {
            String q = "";
            if (c.getCount() == 1) {
                q = QueryTabungan.splitParam("UPDATE tblidentitas SET namatoko=? ,notelp=? ,alamat=? ,caption1=? ,caption2=? ,caption3=? WHERE id=? ", p1);
            } else {
                q = QueryTabungan.splitParam("INSERT INTO tblidentitas VALUES(?,?,?,?,?,?,?)", p);
            }
            if (db.exc(q)) {
                Toast.makeText(this, ModulTabungan.getResString(this,R.string.saved), Toast.LENGTH_SHORT).show();
                finish();
            } else {
                Toast.makeText(this, ModulTabungan.getResString(this,R.string.notsaved), Toast.LENGTH_SHORT).show();
            }
        }
    }

    public void clear(View view) {
        ModulTabungan.setText(v,R.id.edtNamaToko,null);
        ModulTabungan.setText(v,R.id.edtAlamatToko,null);
        ModulTabungan.setText(v,R.id.edtTeleponToko,null);
        ModulTabungan.setText(v,R.id.edtCaption1,null);
        ModulTabungan.setText(v,R.id.edtCaption2,null);
        ModulTabungan.setText(v,R.id.edtCaption3,null);
    }
    @Override
