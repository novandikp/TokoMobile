...
public class MenuTransaksiKeuanganKeluarTabungan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu_transaksi_keuangan_keluar_tabungan);
    ...
    public void tambah(View view) {
        ...
        if (!dataBenar){
            Toast.makeText(MenuTransaksiKeuanganKeluarTabungan.this, R.string.datasalah, Toast.LENGTH_SHORT).show();
        }else {
            AlertDialog dialog =new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton(R.string.yes, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            if (db.exc(q[0])){
                                Toast.makeText(MenuTransaksiKeuanganKeluarTabungan.this, R.string.successAdd, Toast.LENGTH_SHORT).show();
                                finish();
                            }
                        }
                    })
