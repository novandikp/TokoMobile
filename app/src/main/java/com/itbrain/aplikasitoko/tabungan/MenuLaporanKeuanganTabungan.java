...
public class MenuLaporanKeuanganTabungan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu_laporan_keuangan_tabungan);
        ...
        if (type.equals("anggota")) {
            ...
            mIbtnSearch.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    startActivityForResult(new Intent(MenuLaporanKeuanganTabungan.this, MenuTransaksiCariTabungan.class).putExtra("type", "simpanan").putExtra("fromLaporan", true), 3000);
                }
            });
...
//        setSupportActionBar(toolbar);
        ...
        if (type.equals("transaksi")||type.equals("keuangan")){
            ...
            mBtnTglAwal.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Dialog datePicker=new DatePickerDialog(MenuLaporanKeuanganTabungan.this, new DatePickerDialog.OnDateSetListener() {
                        @Override
    ...
    public void exportExcel(View view) {
        startActivity(new Intent(this,MenuExportExcelKeuanganTabungan.class).putExtra("type",type));
    }
